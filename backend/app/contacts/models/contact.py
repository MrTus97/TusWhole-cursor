...
class Contact(models.Model):
    ...
    nickname = models.CharField(max_length=100, blank=True, verbose_name="Biệt danh")
    occupation = models.CharField(max_length=200, blank=True, verbose_name="Ngành nghề")
